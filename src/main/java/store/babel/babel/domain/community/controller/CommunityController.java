package store.babel.babel.domain.community.controller;
...
import store.babel.babel.domain.community.service.CommunityService;
import store.babel.babel.domain.community.service.command.CommunitySearchCommand;
import store.babel.babel.domain.community.service.result.CommunitiesWithPaginationResult;
import store.babel.babel.domain.community.service.result.CommunityResult;
import store.babel.babel.domain.community.service.result.CommunityWithAnswersAndCommentsResult;
